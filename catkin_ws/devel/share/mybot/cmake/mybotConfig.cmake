...
if("TRUE" STREQUAL "TRUE")
  set(mybot_SOURCE_PREFIX /home/deep/study/catkin_ws/src/mybot)
  set(mybot_DEVEL_PREFIX /home/deep/study/catkin_ws/devel)
  set(mybot_INSTALL_PREFIX "")
  set(mybot_PREFIX ${mybot_DEVEL_PREFIX})
else()
  set(mybot_SOURCE_PREFIX "")
  set(mybot_DEVEL_PREFIX "")
  set(mybot_INSTALL_PREFIX /home/deep/study/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'deep <deep@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/deep/study/catkin_ws/src/mybot/${idir}'.  ${_report}")
    endif()
